...
Pulse Overlay is a lightweight, configurable Windows performance overlay. It renders one click-through horizontal line and lets you independently enable FPS, clock, CPU/GPU use and temperature, RAM/VRAM, disk, network down/up speed, clocks, and power.
